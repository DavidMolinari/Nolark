...
<section id="casques">
    ...
    <article>
        <img src="../images/casques/piste/Skyline-Multi-Psyco-White-Gunmetal-Blue.jpg"
             alt="AGV Skyline Multi Psyco White Gunmetal blue"/>
        <p class="stockok"><abbr data-tip="15 casques en stock">stock</abbr></p>
        <p class="prix">229,99€</p>
        <p class="marque">AGV</p>
    ...
    <!-- ------------------------- LIGNE N°3 ------------------------- -->
    <article>
        <img src="../images/casques/piste/Skyline-Multi-Psyco-White-Gunmetal-Red.jpg"
             alt="AGV Skyline Multi Psyco White Gunmetal red"/>
        <p class="stockok"><abbr data-tip="Plus que 3 en stock...">stock</abbr></p>
        <p class="prix">245€</p>
        <p class="marque">AGV</p>
    ...
    <article>
        <img src="../images/casques/piste/skyline-multi-psyco-white-gunmetal.jpg"
             alt="AGV Skyline Multi Psyco White Gunmetal"/>
        <p class="stockok"><abbr data-tip="25 casques en stock">stock</abbr></p>
        <p class="prix">245€</p>
        <p class="marque">AGV</p>
