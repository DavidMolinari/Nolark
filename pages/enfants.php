...
<section id="video">
    <article>
        ...
        <p>On est tous d'accord pour dire que la sécurité est primordiale lorsqu'on roule à deux roues. Personne
            n'envisagerait de rouler sans casque ! Et pourtant, certains omettent l'essentiel : Attacher son casque
            !</p>
        <p>C'est pourquoi Nolark vous présente cette vidéo conçue par "<a href="http://scootxperience.com"
                                                                          target="_blank">ScootXperience</a>" qui vous
            démontre que le fait d'attacher son casque peut tout changer...</p>
...
<section id="casques">
    ...
    <article>
        <img src="../images/casques/enfants/casque-enfant-nexx-x60-vision-plus-rose.jpg"
             alt="Nexx x60 Vision plus rose"/>
    ...
    <!-- ------------------------- LIGNE N°3 ------------------------- -->
    <article>
        <img src="../images/casques/enfants/casque-nexx-x60-cool-kids-blanc-brillant.jpg"
             alt="Nexx x60 Cool Kids blanc brillant"/>
        <p class="stockok"><abbr data-tip="Plus que 3 en stock...">stock</abbr></p>
        <p class="prix">245€</p>
        <p class="marque">Nexx</p>
    ...
    <article>
        <img src="../images/casques/enfants/casque-nexx-x60-kid-vision-neon-jaune.jpg"
             alt="Nexx x60 Cool Kids Vision Neon Jaune"/>
        <p class="stockok"><abbr data-tip="Plus que 3 en stock...">stock</abbr></p>
        <p class="prix">245€</p>
        <p class="marque">Nexx</p>
    ...
    <article>
        <img src="../images/casques/enfants/casque-nexx-x60-kid-vision-neon-orange.jpg"
             alt="Nexx x60 Cool Kids Vision Neon orange"/>
        <p class="stockok"><abbr data-tip="15 casques en stock">stock</abbr></p>
        <p class="prix">245€</p>
        <p class="marque">Nexx</p>
    ...
    <!-- ------------------------- LIGNE N°4 ------------------------- -->
    <article>
        <img src="../images/casques/enfants/casque-nexx-x60-kids-vintage-noir-noir.jpg"
             alt="Nexx x60 Cool Kids Vintage noir noir"/>
        <p class="stockok"><abbr data-tip="Plus que 3 en stock...">stock</abbr></p>
        <p class="prix">245€</p>
        <p class="marque">Nexx</p>
